...
const Card = ({ data, size, img }) => {
    ...
    const likedTrack = (data) => {
        ...
        // 1 QUE USUARIO ESTA LOGEADO
        // 2 QUE CANCION QUIERE AÑADIR
        // 3 EDITAR ESE USUARIO AÑADIENDO LA CANCION
    ...
    return (
        ...
        <div className={size} >
            {usersData.isLogged ? <button onClick={() => likedTrack(data)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-suit-heart" viewBox="0 0 16 16">
